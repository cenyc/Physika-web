...
//0是cloth，1是fuild
const simTypeLog = [
    "Request cloth simulation initialization file...",
    "Request fluid simulation initialization file..."
]
...
function fetchConfig(simType) {
    let reqInitConfig = {
        simType: simType,
        log: simTypeLog[simType]
    };
    ...
    return new Promise((resolve, reject) => {
        ...
        fetch('/loadConfig', {
            ...
            .then(res => {
                ...
                resolve(buildDataStructure(deepCopy(initConfig)));
            });
    });
...
export { 
    fetchConfig as physikaLoadConfig
};
